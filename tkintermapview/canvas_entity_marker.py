...
class EntityMarker:
    def __init__(self,
                 ...
                 font=None,
                 marker_color_inside: str = "#9B261E",
        ...
        self.marker_color_inside = marker_color_inside
    ...
    def set_heading(self, deg_head):
        self.heading = deg_head
        self.draw()
    ...
    def set_polygon_offsets(self, heading):
        x_offsets = [23, -14, 14]
        y_offsets = [23, -23, -23]
    ...
    def draw(self, event=None):
        ...
        if not self.deleted:
            if 0 - 50 < canvas_pos_x < self.map_widget.width + 50 and 0 < canvas_pos_y < self.map_widget.height + 70:
                ...
                x_offsets, y_offsets = self.set_polygon_offsets(self.heading)
                if self.polygon is None:
                    self.polygon = self.map_widget.canvas.create_polygon(canvas_pos_x + x_offsets[0], canvas_pos_y + y_offsets[0],
                                                                         canvas_pos_x + x_offsets[1], canvas_pos_y + y_offsets[1],
                                                                         canvas_pos_x + x_offsets[2], canvas_pos_y + y_offsets[2],
                    ...
                    self.map_widget.canvas.coords(self.polygon,
                                                  canvas_pos_x + x_offsets[0], canvas_pos_y + y_offsets[0],
                                                  canvas_pos_x + x_offsets[1], canvas_pos_y + y_offsets[1],
                                                  canvas_pos_x + x_offsets[2], canvas_pos_y + y_offsets[2])
